...
public class FN {
    ...
    //testing
    public static void addSlideRLFragmentUpFragment(int container, FragmentActivity fragmentActivity, Fragment fragment, String name) {
        fragmentTransaction = fragmentActivity.getSupportFragmentManager().beginTransaction().setCustomAnimations(R.anim.slide_left, R.anim.slide_right, R.anim.slide_left, R.anim.slide_right);
        fragmentTransaction.add(container, fragment);
        fragmentTransaction.attach(fragment);
        fragmentTransaction.addToBackStack(name);
        fragmentTransaction.commit();
